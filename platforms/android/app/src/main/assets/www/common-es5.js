      ...
      var TurnosService = /*#__PURE__*/function () {
        ...
        _createClass(TurnosService, [{
          ...
          value: function getTurnos() {
            return this.http.get(this.baseUrl + "/obtenerTurnos.php");
          }
        }, {
          key: "getTurnosByDeviceId",
          value: function getTurnosByDeviceId(id) {
            return this.http.get(this.baseUrl + "/obtenerTurnosByDeviceId.php?deviceId=" + id);
          }
        }, {
          key: "saveTurno",
          value: function saveTurno(turno) {
            return this.http.post(this.baseUrl + "/altaTurno.php", turno);
          }
        }, {
          key: "eliminarTurno",
          ...
          value: function cancelarTurno(id, estado) {
            return this.http.get(this.baseUrl + "/cambiarEstadoTurno.php?id=" + id + "&estado=" + estado);
          }
        }, {
          key: "acceso",
          value: function acceso(usuario) {
            return this.http.post(this.baseUrl + "/acceso.php", usuario);
          }
        }]);
