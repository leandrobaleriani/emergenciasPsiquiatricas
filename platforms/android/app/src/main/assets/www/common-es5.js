    ...
    function srcAppServicesTurnosServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TurnosService = /*#__PURE__*/function () {
        function TurnosService(http) {
          ...
          this.http = http;
          this.baseUrl = "https://bibal.com.ar/servicios/ferzam";
        }

        _createClass(TurnosService, [{
          key: "getTurnos",
          value: function getTurnos() {
            return this.http.get(this.baseUrl + "/obtenerReservas.php");
          }
        }, {
          key: "getTurnosByUserId",
          value: function getTurnosByUserId(id) {
            return this.http.get(this.baseUrl + "/obtenerReservaByUserId.php?userId=" + id);
          }
        }, {
          key: "saveTurno",
          value: function saveTurno(reserva) {
            return this.http.post(this.baseUrl + "/altaReserva.php", reserva);
          }
        }, {
          key: "eliminarTurno",
          value: function eliminarTurno(id) {
            this.http["delete"](this.baseUrl + "/" + id);
          }
        }, {
          key: "cancelarTurno",
          value: function cancelarTurno(id, estado) {
            return this.http.get(this.baseUrl + "/cambiarEstadoReserva.php?id=" + id + "&estado=" + estado);
          }
        }, {
          key: "getTurnosByFecha",
          value: function getTurnosByFecha(fecha) {
            return this.http.get(this.baseUrl + "/obtenerReservasByFecha.php?fecha=" + fecha);
          }
        }]);
      ...
      TurnosService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      TurnosService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], TurnosService);
      /***/
    }
